    ...
    <div className="p-6 md:p-10 space-y-8 max-w-7xl mx-auto">
      ...
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <motion.div 
          ...
          className="space-y-1"
        >
          <h1 className="text-xl font-bold text-black flex items-center gap-3">
                ...
                <tr>
                  <td colSpan={7} className="py-16">
                    <div className="flex flex-col items-center justify-center text-center px-4">
                      ...
                      <h3 className="text-lg font-bold text-black">Tidak ada pesanan</h3>
                  ...
                  {filteredOrders.map((order) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Price */}
                        <td className="py-4 px-6 text-xs font-medium text-emerald-600 text-center">
                            ...
                            {statusInfo.text === "Menunggu Konfirmasi" ? (
                              <>
                                <button
                                  ...
                                  className="px-2.5 py-1.5 rounded-lg bg-black text-white hover:bg-zinc-800 text-[10px] font-medium transition-all shadow-sm flex items-center gap-1 active:scale-95"
                                >
